...
def gpkg_ewkb_adapter(gpkg_geom):
    return Binary(gpkg.geom_to_ewkb(gpkg_geom))


register_adapter(gpkg.GPKGGeometry, gpkg_ewkb_adapter)


class WorkingCopyPostgis(WorkingCopy):
    ...
    def TRACKING_TABLE(self):
        return Identifier(self.sno_schema, "track")

    @property
    def META_TABLE(self):
        return Identifier(self.sno_schema, "meta")
